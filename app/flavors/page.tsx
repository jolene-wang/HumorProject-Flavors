...
export default async function FlavorsPage() {
  ...
  // Get step counts for each flavor
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Link
                    ...
                    className="px-3 py-1.5 text-sm rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 font-medium transition-colors"
                    title="Manage steps"
                  >
                    ⚙️ Steps
                  </Link>
                  <Link
                    ...
                    className="px-3 py-1.5 text-sm rounded-lg bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-900 font-medium transition-colors"
                    title="Test this flavor"
                  >
                    🧪 Test
                  </Link>
                  <Link
                    href={`/flavors/${f.id}/captions`}
                    className="px-3 py-1.5 text-sm rounded-lg bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-400 hover:bg-purple-200 dark:hover:bg-purple-900 font-medium transition-colors"
                    title="View captions"
                  >
                    💬 Captions
                  </Link>
                  <Link
                    href={`/flavors/${f.id}`}
                    className="px-3 py-1.5 text-sm rounded-lg bg-yellow-100 dark:bg-yellow-950 text-yellow-700 dark:text-yellow-400 hover:bg-yellow-200 dark:hover:bg-yellow-900 font-medium transition-colors"
                    title="Edit flavor"
                  >
                    ✏️ Edit
                  </Link>
                  <DeleteFlavorButton id={f.id} name={f.name} />
                </div>
              </div>
            </div>
          ))}
